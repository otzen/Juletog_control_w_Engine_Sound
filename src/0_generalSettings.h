...
// EEPROM settings ---------------------------------------------------------------------------------------------------------------------------------
uint8_t eeprom_id = 1; // change this id (between 1 and 255, compare with serial monitor), if you want to restore EEPROM defaults (only executed 1x) <<------------- NOTE!
...
String default_ssid = "jule_tog"; // Select this network
